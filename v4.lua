...
local DISCORD_LINK = "https://discord.gg/YgYgPZHuHN"

if CoreGui:FindFirstChild("KlevorxSentinel") then
    CoreGui.KlevorxSentinel:Destroy()
end
if CoreGui:FindFirstChild("KlevorxLoader") then
    CoreGui.KlevorxLoader:Destroy()
end
if CoreGui:FindFirstChild("KlevorxAdminMenu") then
...
local ConfigModule = {
    Categories = {"ALL", "ADMIN", "ECON", "GAMEPASS", "MOVEMENT", "OBFUSCATED", "MALICIOUS"},
    SuspiciousPatterns = {
...
function CoreModule.AnalyzeObject(_0xc5)
    ...
    for _, _0xe7 in ipairs(ConfigModule.SuspiciousPatterns) do
        if _0xd6:find(_0xe7.pattern) then
            return true, _0xe7.category, _0xe7.color, "GOOD"
        end
    end
    if UtilsModule.IsObfuscated(_0xc5.Name) then
        CoreModule.ObfuscatedCount = CoreModule.ObfuscatedCount + 1
        return true, "OBFUSCATED", Color3.fromRGB(220, 80, 255), "GOOD"
    end
    if _0xc5.Parent == LocalPlayer or (_0xc5:IsA("LocalScript") and not _0xc5.Parent:IsA("PlayerScripts")) then
        return true, "MALICIOUS", Color3.fromRGB(255, 60, 100), "GOOD"
    end
    return false, "ALL", Color3.fromRGB(130, 130, 145), "USELESS"
end
...
function CoreModule.ExportToJson()
    ...
    for _, _0x109 in ipairs(CoreModule.Logs) do
        table.insert(_0xf8, {
            ...
            path = _0x109.instance and _0x109.instance:GetFullName() or "N/A"
        })
    end
    local _0x11a, _0x12b = pcall(function() return HttpService:JSONEncode(_0xf8) end)
    if _0x11a and writefile then
        local _0x13c = "KlevorxSentinel_" .. os.time() .. ".json"
        writefile(_0x13c, _0x12b)
        return true, _0x13c
    end
    return false, "Export capability unavailable."
end
...
function HooksModule.Initialize(_0x14d)
    pcall(function()
        local _0x15e = 0
        HooksModule.OldNamecall = hookmetamethod(game, "__namecall", function(_0x16f, ...)
            if HooksModule.SpyActive and (typeof(_0x16f) == "Instance") then
                local _0x170 = getnamecallmethod()
                if _0x170 == "FireServer" or _0x170 == "InvokeServer" then
                    local _0x181 = tick()
                    if (_0x181 - _0x15e) >= 0.05 then
                        ...
                        task.defer(function()
                            if _0x192 and _0x192.Parent then
                                _0x14d(string.format("[TRAFFIC] %s -> %s", _0x170, _0x192.Name), Color3.fromRGB(255, 150, 50), _0x192, "ALL", "GOOD")
                            end
                        end)
                    end
                end
...
PromptGui.Name = "KlevorxDiscordPopup"
...
local PopupFrame = Instance.new("Frame", PromptGui)
...
PopupTitle.Text = "Join Klevorx Sentinel Community"
...
local PopupDesc = Instance.new("TextLabel", PopupFrame)
PopupDesc.Size = UDim2.new(1, -30, 0, 45)
PopupDesc.Position = UDim2.new(0, 15, 0, 45)
PopupDesc.BackgroundTransparency = 1
PopupDesc.Text = "Click below to copy your invite link or open the browser to join our official Discord server."
...
local JoinBtn = Instance.new("TextButton", PopupFrame)
...
local DismissBtn = Instance.new("TextButton", PopupFrame)
...
Instance.new("UICorner", DismissBtn).CornerRadius = UDim.new(0, 4)
...
JoinBtn.MouseButton1Click:Connect(function()
    pcall(function()
        ...
        if syn and syn.request then
            syn.request({ Url = "http://127.0.0.1:6463/rpc?v=1", Method = "POST", Headers = {["Content-Type"] = "application/json", ["Origin"] = "https://discord.com"}, Body = HttpService:JSONEncode({cmd = "INVITE_BROWSER", args = {code = "YgYgPZHuHN"}, nonce = HttpService:GenerateGUID(false)}) })
        end
    end)
...
local UIModule = {}
UIModule.CurrentCategory = "ALL"
UIModule.SearchQuery = ""
UIModule.QualityFilter = "ALL"
...
function UIModule.BuildInterface()
    ...
    ScreenGui.Name = "KlevorxSentinel"
    ...
    local AdminMenuBtn = Instance.new("TextButton")
    ...
    Instance.new("UICorner", AdminMenuBtn).CornerRadius = UDim.new(0, 4)
    ...
    Instance.new("UICorner", ScanAllBtn).CornerRadius = UDim.new(0, 4)
    ...
    local QualityFilterBtn = Instance.new("TextButton")
    ...
    QualityFilterBtn.Text = "Filter: ALL"
    ...
    Instance.new("UICorner", QualityFilterBtn).CornerRadius = UDim.new(0, 4)

    QualityFilterBtn.MouseButton1Click:Connect(function()
        if UIModule.QualityFilter == "ALL" then
            UIModule.QualityFilter = "GOOD"
            QualityFilterBtn.Text = "Filter: GOOD"
            QualityFilterBtn.BackgroundColor3 = Color3.fromRGB(30, 150, 70)
        elseif UIModule.QualityFilter == "GOOD" then
            UIModule.QualityFilter = "USELESS"
            QualityFilterBtn.Text = "Filter: USELESS"
    ...
    for _0x1f8, _0x209 in ipairs(ConfigModule.Categories) do
        ...
        catBtn.BackgroundColor3 = (_0x209 == "ALL") and Color3.fromRGB(20, 130, 90) or Color3.fromRGB(25, 25, 36)
        catBtn.Text = _0x209
        ...
        catBtn.MouseButton1Click:Connect(function()
            ...
            for _, _0x21a in ipairs(FilterBar:GetChildren()) do
                if _0x21a:IsA("TextButton") then _0x21a.BackgroundColor3 = Color3.fromRGB(25, 25, 36) end
            end
    ...
    StatsLabel.Text = "Targets: 0 | Logs: 0 | Status: Idle"
    ...
    InfoBox.Text = "Select an endpoint from the left feed to analyze targets and execute safety assessments."
    ...
    ArgInput.PlaceholderText = "Payload (Default: VulnTestProbe)"
    ...
    Instance.new("UICorner", ArgInput).CornerRadius = UDim.new(0, 5)

    local function _0x22b(_0x23c, _0x24d)
        local _0x25e = Instance.new("TextButton")
        ...
        local _0x270 = Instance.new("UIStroke")
    ...
    local TestFireBtn = _0x22b("Execute Remote Call", Color3.fromRGB(200, 110, 40))
    local StressBtn = _0x22b("Run Stress Test (50x)", Color3.fromRGB(200, 50, 50))
    local MultiFuzzBtn = _0x22b("Multi-Type Parameter Fuzzer", Color3.fromRGB(130, 60, 180))
    local AuditGamepassBtn = _0x22b("Audit Client Validation", Color3.fromRGB(40, 130, 200))
    local SpyToggleBtn = _0x22b("Toggle Traffic Spy Interceptor", Color3.fromRGB(50, 160, 90))
    local DecompileBtn = _0x22b("Decompile Source Script", Color3.fromRGB(90, 70, 180))
    local CopySnippetBtn = _0x22b("Copy Exploit Snippet", Color3.fromRGB(40, 150, 150))
    local ClearFeedBtn = _0x22b("Clear Log Feed", Color3.fromRGB(80, 80, 95))
    ...
    MinBtn.MouseButton1Click:Connect(function()
        ...
        MinBtn.Text = _0x281 and "+" or "—"
    end)

    local AdminGui = Instance.new("ScreenGui")
    AdminGui.Name = "KlevorxSentinelAdmin"
    ...
    AdminTitle.Text = "Command Console"
    ...
    local AdminClose = Instance.new("TextButton", AdminTop)
    ...
    Instance.new("UICorner", AdminClose).CornerRadius = UDim.new(0, 4)
    AdminClose.MouseButton1Click:Connect(function() AdminGui.Enabled = false end)

    local CmdInput = Instance.new("TextBox", AdminFrame)
    ...
    CmdInput.PlaceholderText = "Enter command... (e.g. speed 100, fly, tp)"
    ...
    Instance.new("UICorner", CmdInput).CornerRadius = UDim.new(0, 4)

    local CmdOutput = Instance.new("TextLabel", AdminFrame)
    ...
    Instance.new("UICorner", CmdOutput).CornerRadius = UDim.new(0, 4)
    ...
    CmdInput.FocusLost:Connect(function(_0x2f8)
        ...
        CmdInput.Text = ""
        local _0x31a = {}
        for _0x32b in _0x309:gmatch("%S+") do
        ...
        local _0x36f = _0x35e and _0x35e:FindFirstChildOfClass("Humanoid")
        local _0x370 = _0x35e and _0x35e:FindFirstChild("HumanoidRootPart")

        if _0x33c == "speed" and _0x36f and tonumber(_0x34d) then
            _0x36f.WalkSpeed = tonumber(_0x34d)
            CmdOutput.Text = ">> WalkSpeed updated: " .. tostring(_0x34d)
        elseif (_0x33c == "jp" or _0x33c == "jumppower") and _0x36f and tonumber(_0x34d) then
            _0x36f.JumpPower = tonumber(_0x34d)
            CmdOutput.Text = ">> JumpPower updated: " .. tostring(_0x34d)
        elseif _0x33c == "gravity" and tonumber(_0x34d) then
            Workspace.Gravity = tonumber(_0x34d)
            CmdOutput.Text = ">> Gravity updated: " .. tostring(_0x34d)
        elseif _0x33c == "respawn" then
            if _0x36f then _0x36f.Health = 0 end
            CmdOutput.Text = ">> Character reset triggered."
        elseif _0x33c == "noclip" then
            RunService:BindToRenderStep("KlevorxNoclip", 1, function()
                if LocalPlayer.Character then
                    for _, _0x381 in ipairs(LocalPlayer.Character:GetDescendants()) do
                        if _0x381:IsA("BasePart") then _0x381.CanCollide = false end
                    end
                end
            end)
            CmdOutput.Text = ">> Collision disabled (Noclip active)."
        elseif _0x33c == "clip" then
            pcall(function() RunService:UnbindFromRenderStep("KlevorxNoclip") end)
            CmdOutput.Text = ">> Standard collision physics restored."
        elseif _0x33c == "fly" then
        ...
        elseif _0x33c == "tp" and _0x34d then
            ...
            if _0x3c5 and _0x3c5.Character and _0x3c5.Character:FindFirstChild("HumanoidRootPart") and _0x370 then
...
function UIModule.RefreshFilters()
    for _, _0x3e7 in ipairs(CoreModule.LogNodes) do
        local _0x3f8 = (UIModule.CurrentCategory == "ALL" or _0x3e7.category == UIModule.CurrentCategory)
        local _0x409 = (UIModule.SearchQuery == "" or _0x3e7.text:lower():find(UIModule.SearchQuery))
        local _0x41a = true
        if UIModule.QualityFilter == "GOOD" then
            _0x41a = (_0x3e7.quality == "GOOD")
        elseif UIModule.QualityFilter == "USELESS" then
            _0x41a = (_0x3e7.quality == "USELESS")
        end
...
function UIModule.AppendLog(_0x42b, _0x43c, _0x44d, _0x45e, _0x46f)
    local _0x470 = os.date("%H:%M:%S")
    local _0x481 = string.format("[%s] %s", _0x470, _0x42b)
    local _0x492 = _0x46f or "GOOD"
    
    local _0x4a3 = Instance.new("TextButton")
    ...
    Instance.new("UICorner", _0x4a3).CornerRadius = UDim.new(0, 4)

    if _0x44d then
        _0x4a3.MouseButton1Click:Connect(function()
            CoreModule.ActiveTarget = _0x44d
            UIModule.InfoBox.Text = string.format("Target Name: %s\nClass Type: %s\nFull Path: %s", 
                _0x44d.Name, _0x44d.ClassName, _0x44d:GetFullName())
        end)
    end

    local _0x4b4 = {instance = _0x4a3, category = _0x45e or "ALL", text = _0x481, quality = _0x492}
...
UIModule.ScanBtn.MouseButton1Click:Connect(function()
    ...
    UIModule.ScanBtn.Text = "Scanning..."
    ...
    UIModule.InfoBox.Text = "Select an endpoint from the left feed to analyze targets."

    UIModule.AppendLog("[SENTINEL] Initializing security heuristic scan across core containers...", Color3.fromRGB(255, 180, 50), nil, "ALL", "GOOD")
    ...
    task.spawn(function()
        ...
        for _, _0x4d6 in ipairs({ReplicatedStorage, ReplicatedFirst, Workspace}) do
            ...
            if _0x4e7 and _0x4f8 then
                for _, _0x509 in ipairs(_0x4f8) do
                    if _0x509:IsA("RemoteEvent") or _0x509:IsA("RemoteFunction") or _0x509:IsA("UnreliableRemoteEvent") then
                        _0x4c5 = _0x4c5 + 1
                        local _0x51a, _0x52b, _0x53c, _0x54d = CoreModule.AnalyzeObject(_0x509)
                        local _0x55e = _0x51a and string.format("[%s] ", _0x52b) or string.format("[%s] ", _0x509.ClassName)
        ...
        UIModule.AppendLog("[COMPLETE] Audit sweep concluded. Found " .. _0x4c5 + CoreModule.ObfuscatedCount .." targets.", Color3.fromRGB(50, 220, 130), nil, "ALL", "GOOD")
        UIModule.ScanBtn.Text = "Rescan"
...
UIModule.ScanAllBtn.MouseButton1Click:Connect(function()
    if CoreModule.ScanningActive then return end
    CoreModule.ScanningActive = true
    UIModule.ScanAllBtn.Text = "Scanning..."
    CoreModule.ObfuscatedCount = 0
    ...
    CoreModule.Logs = {}
    CoreModule.ActiveTarget = nil
    UIModule.InfoBox.Text = "Comprehensive deep scan running across all game services..."

    UIModule.AppendLog("[DEEP SCAN ALL] Initiating universal container and service sweep...", Color3.fromRGB(200, 100, 255), nil, "ALL", "GOOD")
    ...
    task.spawn(function()
        ...
        for _, _0x4d6 in ipairs(_0x570) do
            ...
            if _0x4e7 and _0x4f8 then
                for _, _0x509 in ipairs(_0x4f8) do
                    local _0x581 = _0x509:IsA("RemoteEvent") or _0x509:IsA("RemoteFunction") or _0x509:IsA("UnreliableRemoteEvent") or _0x509:IsA("BindableEvent") or _0x509:IsA("BindableFunction") or _0x509:IsA("ModuleScript") or _0x509:IsA("LocalScript")
                    
                    if _0x581 then
                        _0x56f = _0x56f + 1
                        local _0x51a, _0x52b, _0x53c, _0x54d = CoreModule.AnalyzeObject(_0x509)
                        
                        if not _0x51a and (_0x509:IsA("ModuleScript") or _0x509:IsA("LocalScript")) then
                            _0x52b = "MALICIOUS"
                        ...
                        local _0x55e = _0x51a and string.format("[%s] ", _0x52b) or string.format("[%s] ", _0x509.ClassName)
                        UIModule.AppendLog(_0x55e .. _0x509:GetFullName(), _0x53c, _0x509, _0x52b ~= "ALL" and _0x52b or "MALICIOUS", _0x54d)
                        task.wait(0.001)
                    end
                end
            end
        ...
        UIModule.AppendLog(string.format("[DEEP SCAN COMPLETE] Swept all services. Total index points evaluated: %d", _0x56f), Color3.fromRGB(50, 255, 150), nil, "ALL", "GOOD")
        UIModule.ScanAllBtn.Text = "Scan All"
        CoreModule.ScanningActive = false
    end)
end)
...
UIModule.TestFireBtn.MouseButton1Click:Connect(function()
    ...
    local _0x603 = UIModule.ArgInput.Text ~= "" and UIModule.ArgInput.Text or "VulnTestProbe"
    local _0x4e7, _0x614 = pcall(function()
        if CoreModule.ActiveTarget:IsA("RemoteEvent") or CoreModule.ActiveTarget:IsA("UnreliableRemoteEvent") then
            CoreModule.ActiveTarget:FireServer(_0x603)
        elseif CoreModule.ActiveTarget:IsA("RemoteFunction") then
...
UIModule.StressBtn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        for _0x1f8 = 1, 50 do
            pcall(function()
                if CoreModule.ActiveTarget:IsA("RemoteEvent") or CoreModule.ActiveTarget:IsA("UnreliableRemoteEvent") then
                    CoreModule.ActiveTarget:FireServer("StressTest_" .. _0x1f8)
                elseif CoreModule.ActiveTarget:IsA("RemoteFunction") then
                    CoreModule.ActiveTarget:InvokeServer("StressTest_" .. _0x1f8)
                end
            end)
            task.wait(0.01)
        end
...
UIModule.MultiFuzzBtn.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        local _0x625 = {"ExploitPayload", {1, 2, 3}, true, 1333337, nil, workspace}
    ...
    task.spawn(function()
        ...
        for _, _0x4d6 in ipairs({ReplicatedStorage, ReplicatedFirst, Workspace}) do
            for _, _0x509 in ipairs(_0x4d6:GetDescendants()) do
                ...
                if _0xd6:find("gamepass") or _0xd6:find("pass") or _0xd6:find("vip") or _0xd6:find("prompt") then
                    _0x647 = _0x647 + 1
                    UIModule.AppendLog("[CLIENT CHECK]: " .. _0x509:GetFullName(), Color3.fromRGB(255, 90, 150), _0x509, "GAMEPASS", "GOOD")
                end
            end
        end
...
UIModule.CopySnippetBtn.MouseButton1Click:Connect(function()
    if not CoreModule.ActiveTarget then UIModule.InfoBox.Text = "Error: No target endpoint selected." return end
    local _0x669 = string.format("local remote = %s\nremote:%s(\"Payload\")", CoreModule.ActiveTarget:GetFullName(), CoreModule.ActiveTarget:IsA("RemoteEvent") and "FireServer" or "InvokeServer")
...
RunService.RenderStepped:Connect(function()
    local _0x67a = CoreModule.ScanningActive and "Scanning" or (HooksModule.SpyActive and "Monitoring" or "Idle")
